...
def cnpj():
    ...
    request = requests.get(
        'https://tudosobretodos.info/$cpf'.format(cnpj_input))
    ...
    if 'message' not in cnpj_data:
        ...
        print("CPF: {}".format(cnpj_data['CPF']))
        print("Nome: {}".format(cnpj_data['nome']))
        print("Endereço: {}".format(cnpj_data['Endereço']))
        print("Telefone: {}".format(cnpj_data['telefone']))
        print("E-mail: {}".format(cnpj_data['email']))
        print("Nascimento: {}".format(cnpj_data['Nascimento']))
